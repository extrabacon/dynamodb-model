...
var DynamoModel = function (schema, options) {

    if (!schema.tableName) {
        throw new Error('DynamoSchema.tableName is required');
    }
    ...
    DynamoModel.prototype.putItem = function (item, options, callback) {
        ...
        return this.dynamodb.putItem(params, callback);
    };
    ...
    DynamoModel.prototype.updateItem = function (key, updates, options, callback) {
        ...
        return this.dynamodb.updateItem(params, callback);
    };
